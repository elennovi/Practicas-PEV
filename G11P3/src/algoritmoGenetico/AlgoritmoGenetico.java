...
public class AlgoritmoGenetico {
	...
	public AlgoritmoGenetico(int tamPoblacion, int numGen, Seleccion fSelec, Cruce fCruce, Mutacion fMutacion, 
			double pCruce, double elitismo, Multiplexor m, Ventana window) {
	...
	private void introducirElite(Individuo[] seleccionados, Individuo[] elite) {
		...
		for (int i = 0; i < tamPoblacion; i++) 
			ordenados.add(new Par(i, seleccionados[i].getFitDesplazado()));
		
		// Los ordenamos de peor a mejor (menor a mayor, porque estamos maximizando)
	...
	private Individuo[] calculaElite() {
		...
		// Ordenamos la lista de mayor a menor (los mayores son los mejores)
